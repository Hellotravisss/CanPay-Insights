-- CanPay Insights - Anonymous Mode Database Schema (Fixed Version)
...
-- 修改 timesheet_entries 的 user_id 为 TEXT
ALTER TABLE timesheet_entries 
  ALTER COLUMN user_id TYPE TEXT USING user_id::TEXT;

-- 修改 timesheet_entries 的 id 为 TEXT (如果需要)
ALTER TABLE timesheet_entries 
  ALTER COLUMN id TYPE TEXT USING id::TEXT;

-- 修改 calculations 的 user_id 为 TEXT
ALTER TABLE IF EXISTS calculations 
  ALTER COLUMN user_id TYPE TEXT USING user_id::TEXT;
