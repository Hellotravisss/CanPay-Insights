        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-10">
              ...
              <div className="pl-11">
                <p className="text-slate-600 leading-relaxed mb-4">
                  To understand how the calculator is used and to publish aggregate research (for example, "which income ranges Canadians calculate most, by province"), we record <strong className="text-slate-800">anonymous usage statistics</strong>: the calculator mode, the province, a broad income range (a bracket such as "$50k–$70k" — never your exact amount), the interface language, and your approximate location (country and region only, derived from your connection — your IP address itself is never stored). These events contain <strong className="text-slate-800">no names, no account identifiers, no IP addresses, and no device fingerprints</strong>, and cannot be linked back to you. We also use privacy-friendly page analytics (Vercel Analytics) to count page views. We do not use advertising trackers and do not monitor your behavior across other apps or websites.
                </p>
              </div>
            </section>
